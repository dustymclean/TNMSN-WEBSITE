...
const AreaPage: React.FC = () => (
  <div className="py-24 bg-white min-h-screen px-4 animate-in text-left">
    <div className="max-w-7xl mx-auto">
      <SectionHeader title="Radius-Based Network (15 Markets)" subtitle="Secured mileage is calculated in all directions from our HQ center point in Tillatoba." />
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {HUBS.map(hub => (
          <a key={hub.id} href={`hub.html?id=${hub.id}`} className="p-8 bg-slate-50 border border-slate-100 rounded-[2.5rem] text-left hover:border-[#c5a059] hover:shadow-xl transition-all">
